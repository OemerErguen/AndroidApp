...
import de.uni_stuttgart.informatik.sopra.sopraapp.activity.TagManagementActivity;
import de.uni_stuttgart.informatik.sopra.sopraapp.adapter.CustomQueryAdapter;
...
public class OwnQueryFragment extends Fragment {
    ...
    public void showCustomQueryDialog(@Nullable CustomQuery customQuery, final boolean isEditMode) {
        ...
        if (isEditMode) {
            ...
            builder.setNeutralButton(R.string.delete_custom_query_label, new DialogInterface.OnClickListener() {
                @Override
    ...
    public boolean initFormField(@Nullable CustomQuery customQuery, final boolean isEditMode) {
        ...
        if (customQuery != null) {
            ...
            if (customQuery.isSingleQuery()) {
                questionModeField.setChecked(true);
            } else {
                questionModeField.setChecked(false);
            }
