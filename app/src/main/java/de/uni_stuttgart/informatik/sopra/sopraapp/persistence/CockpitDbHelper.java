...
public class CockpitDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        if (getQueryRowCount(db) == 0) {
            ...
            addNewQuery(db, "1.3.6.1.4.1.30155.42.3.1", "OpenBSD Testabfrage", true);
            addNewQuery(db, "1.3.6.1.4.1.30155.42.3.4", "OpenBSD Testabfrage 2", true);
    ...
    /**
     * used in {@link de.uni_stuttgart.informatik.sopra.sopraapp.adapter.TagListAdapter}
     *
     * @param position
     * @return
     */
