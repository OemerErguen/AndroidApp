...
- [ ] Alle zur User Story assoziierten Tests sind erfolgreich durchgelaufen.
- [ ] Die Testabdeckung beträgt mindestens 75 %.
- [ ] Der Entwurf wurde aktualisiert.
- [ ] Der Code ist kommentiert.
- [ ] Der Code kompiliert und alle GitLab CI Test-Pipelines sind grün.
- [ ] Neuer Code aus eigenen Branches wird von mindestens einem anderen Teammitglied reviewed.
- [ ] Alle Akzeptanzkriterien der User Stories wurden erfüllt und sind – insofern technisch möglich und realisierbar – automatisiert testbar.
- [ ] [Coding Guideline-Dokument](./Coding Guidelines.md) wurde eingehalten.
- [ ] Die (Entwickler-)Dokumentation wurde dem Task entsprechend erweitert.
- [ ] Die Arbeitszeiten, die während der Umsetzung der User Story entstanden sind, wurden im Zeiterfassungsdokument eingetragen.

**Versionierung (Optional):**
- [ ] Diese Zeilen wurden inkrementiert in der Datei *./app/build.gradle*:
...
> **Note:** Die ersten vier Kriterien wurden bereits vorgegeben.
